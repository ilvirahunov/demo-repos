...
- [Configuring UI5 Web Components](docs-advanced/01-configuration.md)
- [Customizing with `UI Theme Designer`](docs-customizing/01-theme.md)
- [Developing Custom UI5 Web Components](docs-development/02-custom-UI5-Web-Components.md)
- [Creating a Custom UI5 Web Components Package](docs-development/01-custom-UI5-Web-Components-Packages.md)
- [Micro-Frontends and Custom Elements Scoping](docs-advanced/03-scoping.md)
- [F.A.Q.](docsAQ.md)
...
3. Use the UI5 Web Component(s) as you would use any HTML element:
	...
	For more information, see [Importing UI5 Web Components](docs-getting-started/02-importing-components.md) and [Understanding UI5 Web Components APIs](docs-getting-started/03-understanding-components-APIs.md).
...
**Note:** If you wish to manually install dependencies & run the Playground you can check out our [in depth tutorial](docs-contributing/03-playground-app.md)
...
## Contribute
Please check our [Contribution Guidelines](docs-contributing/02-conventions-and-guidelines.md).
